...
[![npm](https://img.shields.io/npm/v/@kollorg/soluta-nostrum.svg)](https://www.npmjs.com/package/@kollorg/soluta-nostrum)
[![downloads](https://img.shields.io/npm/dt/@kollorg/soluta-nostrum.svg)](https://www.npmjs.com/package/@kollorg/soluta-nostrum)
[![types](https://img.shields.io/npm/types/@kollorg/soluta-nostrum.svg)](https://www.npmjs.com/package/@kollorg/soluta-nostrum)
[![licence](https://img.shields.io/github/license/mnasyrov/@kollorg/soluta-nostrum.svg)](https://github.com/kollorg/soluta-nostrum/blob/master/LICENSE)
[![Coverage Status](https://coveralls.io/repos/github/mnasyrov/@kollorg/soluta-nostrum/badge.svg?branch=main)](https://coveralls.io/github/mnasyrov/@kollorg/soluta-nostrum?branch=main)
...
| --------------------------------------------- | ------------------------------------------ | ---------------------------------------------------------- |
| [**@kollorg/soluta-nostrum**][@kollorg/soluta-nostrum/docs]             | Core elements, state and effect management | [Docs][@kollorg/soluta-nostrum/docs], [API][@kollorg/soluta-nostrum/api]             |
| [**@kollorg/soluta-nostrum-react**][@kollorg/soluta-nostrum-react/docs] | Tooling for React.js                       | [Docs][@kollorg/soluta-nostrum-react/docs], [API][@kollorg/soluta-nostrum-react/api] |
...
```
npm install @kollorg/soluta-nostrum @kollorg/soluta-nostrum-react --save
```
...
import { useConst, useObservable, useQuery } from '@kollorg/soluta-nostrum-react';
...
[@kollorg/soluta-nostrum/docs]: packages/@kollorg/soluta-nostrum/README.md
[@kollorg/soluta-nostrum/api]: packages/@kollorg/soluta-nostrum/docs/README.md
[@kollorg/soluta-nostrum-react/docs]: packages/@kollorg/soluta-nostrum-react/README.md
[@kollorg/soluta-nostrum-react/api]: packages/@kollorg/soluta-nostrum-react/docs/README.md
